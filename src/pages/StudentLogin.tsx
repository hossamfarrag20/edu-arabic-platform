    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800">تسجيل دخول الطالب</h1>
          <p className="text-slate-600 mt-2">ادخل إلى حسابك وتابع رحلتك التعليمية</p>
        </div>

        <Card className="shadow-xl border-0">
          <CardHeader className="space-y-1 pb-6">
            <CardTitle className="text-center text-slate-700">أهلاً وسهلاً</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pr-10 border-slate-200 focus:border-green-500 focus:ring-green-500"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    className="pr-10 pl-10 border-slate-200 focus:border-green-500 focus:ring-green-500"
                    required
                  />
                  <button
                    type="button"
